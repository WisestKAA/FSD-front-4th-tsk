...
describe("CurrentValueWrapper", () => {
    let currentValueWrapper: CurrentValueWrapper;
    let valFrom: MockCurrentValue;
    let valTo: MockCurrentValue;

    describe("CurrentValueWrapper / init", () => {
        it(`The element must have class ${StyleClasses.CURRENTVALWRAPPER} if the isHorizontal property is true`, () =>{
        ...
        it(`The element must have classs ${StyleClasses.CURRENTVALWRAPPER} and ${StyleClasses.CURRENTVALWRAPPERV} if the isHorizontal property is false`, () =>{
            currentValueWrapper = new CurrentValueWrapper(false, new MockCurrentValue(), new MockCurrentValue());
            expect(currentValueWrapper.$elem.attr("class")).toBe(`${StyleClasses.CURRENTVALWRAPPER} ${StyleClasses.CURRENTVALWRAPPERV}`);
        });
    });

    describe("CurrentValueWrapper / functions", () => {
        it("The setCurrentValuePosition function must set the position for valFrom if the dictionory property is LEFT", () => {
        ...
        it("The setCurrentValuePosition function must set the position for valFrom if the dictionory property is BOTTOM", () => {
            valFrom = new MockCurrentValue();
            currentValueWrapper = new CurrentValueWrapper(true, valFrom);
        ...
        it("The setCurrentValuePosition function must set the position for valFrom if the dictionory property is RIGHT", () => {
        ...
        it("The setCurrentValuePosition function must set the position for valFrom if the dictionory property is TOP", () => {
            valTo = new MockCurrentValue();
            currentValueWrapper = new CurrentValueWrapper(true, new MockCurrentValue(), valTo);
        ...
        it("The setCurrentValuePosition function must check the intersection of containers of current values and correct they, if they are close", () => {
            valFrom = new MockCurrentValue();
            valTo = new MockCurrentValue();
            valFrom.position = 50;
            valTo.position = 50;
        ...
        it("The setCurrentValue function must set current value for the valFrom if the isRange property is false", () => {
            valFrom = new MockCurrentValue();
            currentValueWrapper = new CurrentValueWrapper(true, valFrom);
        ...
        it("The setCurrentValue function must set current value for the valFrom and the valTo if the isRange property is true", () => {
            valFrom = new MockCurrentValue();
            valTo = new MockCurrentValue();
            currentValueWrapper = new CurrentValueWrapper(true, valFrom, valTo);
        ...
        it("The getCurrentValue function must freturn [valFrom, 0] if the isRange property is false", () => {
            valFrom = new MockCurrentValue();
        ...
        it("The getCurrentValue function must freturn [valFrom, 0] if the isRange property is true", () => {
            valFrom = new MockCurrentValue();
            valTo = new MockCurrentValue();
            valFrom.currentValue = 1;
