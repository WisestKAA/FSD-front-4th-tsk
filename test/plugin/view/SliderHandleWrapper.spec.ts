...
describe("Test SliderHandleWrapper", () => {
    ...
    describe("Test SliderHandleWrapper / init", () => {
        it(`The element must have class ${StyleClasses.HANDLEWRAPPER} if the isHorizontal property is true`, () => {
    ...
    describe("Test SliderHandleWrapper / public function", () => {
        it("The getMaxHandlePosition function must return the MaxHandlePosition of the handleFrom if the isRange property is false", () => {
            wrapper = new SliderHandleWrapper(true, new MockHandle());
            expect(wrapper.getMaxHandlePosition()).toBe(90);
        });

        it("The getMaxHandlePosition function should return a minimum of MaxHandlePosition from handleFrom and handleTo if the isRange property is true", () => {
        ...
        it("The setHandlePosition function must set position for handleFrom if SliderDirection.isFrom()===true", () => {
            handleFrom = new MockHandle();
        ...
        it("The setHandlePosition function must set position for handleTo if SliderDirection.isFrom()===false", () => {
        ...
        it("The getSliderHandlePosition function must return the position of handleFrom if SliderDirection.isFrom()===true", () => {
            handleFrom = new MockHandle();
            wrapper = new SliderHandleWrapper(true, handleFrom);
        ...
        it("The getSliderHandlePosition function must return the position of handleTo if SliderDirection.isFrom()===false", () => {
            handleTo = new MockHandle();
            wrapper = new SliderHandleWrapper(true, new MockHandle(), handleTo);
        ...
        it("The getHandleFromPosition function must return the position of handleFrom", () => {
            handleFrom = new MockHandle();
            wrapper = new SliderHandleWrapper(true, handleFrom);
            handleFrom.position = 10;
        ...
        it("The getHandleToPosition function must return the position of handleTo if the isRange property is true", () => {
            handleTo = new MockHandle();
            wrapper = new SliderHandleWrapper(true, new MockHandle(), handleTo);
            handleTo.position = 10;            
        ...
        it("The getHandleToPosition function must return null if the isRange property is false", () => {
            wrapper = new SliderHandleWrapper(true, new MockHandle());
            expect(wrapper.getHandleToPosition()).toBe(null);
        });

        it("The getIsRange function must return the isRange property", () => {
            wrapper = new SliderHandleWrapper(true, new MockHandle());
            expect(wrapper.getIsRange()).toBe(false);
        });

        it("When the handleFrom changes position, the wrapper checks the intersection of the handles and changes the position if they intersect", () => {
            handleFrom = new MockHandle();
            handleTo = new MockHandle();
        ...
        it("When the handle changes position, the wrapper checks the intersection of the handles and don't changes the position if they don't intersect", () => {
            handleFrom = new MockHandle();
            handleTo = new MockHandle();
        ...
        it("When the handleTo changes position, the wrapper checks the intersection of the handles and changes the position if they intersect", () => {
            handleFrom = new MockHandle();
            handleTo = new MockHandle();
        ...
        it("Changing the position of handle calls handlePositionChangedEvent", () => {
            handleFrom = new MockHandle();
            wrapper = new SliderHandleWrapper(true, handleFrom);
            let mockHandleWrapperEvent = new MockHandleWrapperEvent(wrapper);
            let spy = spyOn(mockHandleWrapperEvent, "eventHandler");
